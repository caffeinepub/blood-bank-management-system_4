...
import type { BloodStock as _BloodStock, Donor as _Donor, Request as _Request, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDonor(arg0: Donor): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addDonor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async countRequestsByStatus(arg0: Variant_pending_approved_rejected): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countRequestsByStatus(to_candid_variant_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createRequest(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllBloodStock(): Promise<Array<BloodStock>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBloodStock();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBloodStock(arg0: string): Promise<BloodStock | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBloodStock(arg0);
    ...
    async getDonor(arg0: Principal): Promise<Donor | null> {
        if (this.processError) {
            try {
    ...
    async getRequestsByStatus(arg0: Variant_pending_approved_rejected): Promise<Array<Request>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRequestsByStatus(to_candid_variant_n3(this._uploadFile, this._downloadFile, arg0));
    ...
    async updateBloodStock(arg0: BloodStock): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBloodStock(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRequestStatus(arg0: bigint, arg1: Variant_pending_approved_rejected): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRequestStatus(arg0, to_candid_variant_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Donor]): Donor | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BloodStock]): BloodStock | null {
    return value.length === 0 ? null : value[0];
}
...
function to_candid_variant_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_pending_approved_rejected): {
    pending: null;
} | {
    approved: null;
} | {
